...
while(True):
    ...
    try:
        ...
        # Convert to grayscale image - 'L' means each pixel is represented by a single value from 0 to 255
        ...
        # Using clip to limit the values between 0 and 255
        ...
        # Creating a test sample an making a prediction
